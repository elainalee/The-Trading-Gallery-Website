       ...
       <div className="marginTop infoPages termsOfUse">
            <main>
                ...
                <div className="section">             
                    ...
                    <li className="body">
                        {OUR_ADVERTISING_PARTNERS_LIST_1_NAME}: {OUR_ADVERTISING_PARTNERS_LIST_1_LINK}
                    </li>
                </div>

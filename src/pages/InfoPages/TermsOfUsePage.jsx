       ...
       <div className="marginTop infoPages termsOfUse">
            <main>
                ...
                <div className="section">             
                    ...
                    <div className="body">{"Address: " + TGG_ADDRESS}</div>

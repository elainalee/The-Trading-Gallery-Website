        ...
        <div className="marginTop infoPages termsAndPolicy">
            <main>
                ...
                <div className="section">
                    ...
                    <ul>
                        <li className="body">{BY_EMAIL} {TGG_EMAIL}</li>
                    </ul>
                </div>
            </main>
